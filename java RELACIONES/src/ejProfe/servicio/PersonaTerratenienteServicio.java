 ...
 */
package ejProfe.servicio;

import ejProfe.entidades.Departamento;
import ejProfe.entidades.PersonaTerrateniente;
...
public class PersonaTerratenienteServicio {
    ...
    public void cargarPersonaTerrateniente() {
        System.out.println("ingrese nuevo arrendatario");
    ...
    public void imprimirPersonasTerratenientes() {
        System.out.println("â•¬â•¬â•¬â•¬PERSONAS CARGADASâ•¬â•¬â•¬â•¬");
        for (PersonaTerrateniente personaUnitario : listaPersonasTerratenientes) {
            System.out.println(personaUnitario);
        }
        //segunda forma
        listaPersonasTerratenientes.forEach((personaUnitario) -> {
            System.out.println(personaUnitario);
         });
    }
